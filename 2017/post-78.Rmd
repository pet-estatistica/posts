...
3 anos Louis sofreu um acidente perfurando o olho esquerdo com uma 
ferramenta, gerando uma infecção que o deixou completamente cego aos 5 
anos.

Mesmo cego se destacava na escola, conseguiu uma bolsa para estudar no 
Instituto Nacional Para Jovens Cegos em Paris. Nesta escola utilizavam
um método para leitura que consistia em letras de forma impressas em 
relevo no papelão para serem reconhecidas pelo tato. Novamente Louis foi 
se destacando e ajudando os colegas.

Aos 12 anos (1821) Braille conheceu o método *Barbier* também conhecido 
como *Escrita Noturna*, criado pelo oficial do exército francês Charles 
Barbier de La Serre. É um código de traços e pontos em relevo impressos 
em papelão usados para enviar ordem codificadas que poderiam ser 
decifradas e lidas até no escuro e sem fazer barulho. Como não foi 
...
Percebendo as limitações do método, Braille foi o aperfeiçoando.
...
primeiras letras são representadas as letras de *k* a *t*, já 
...
concluído em 1824 chamado de *Braille*.

Aos 17 anos Louis já dava aulas, mas seu método não podia ser ensinado. 
...
os sinais em relevo enquanto a esquerda procura o início da próxima 
linha.
